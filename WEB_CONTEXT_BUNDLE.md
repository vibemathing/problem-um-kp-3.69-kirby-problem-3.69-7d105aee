...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.69-kirby-problem-3.69-7d105aee-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.69"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.69-kirby-problem-3.69-7d105aee-v1",
      "problem_contract_sha256": "43b88e13783cf23b2e3e629e5cc660890db3d20ebd6e579eac74cbc2e439563e",
      "problem_id": "problem:um-kp-3.69-kirby-problem-3.69-7d105aee",
      "route_id": "route:um-kp-3.69-kirby-problem-3.69-7d105aee-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.69-kirby-problem-3.69-7d105aee-source-fidelity-01",
      "graph_id": "graph:um-kp-3.69-kirby-problem-3.69-7d105aee-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.69-kirby-problem-3.69-7d105aee-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.69-kirby-problem-3.69-7d105aee-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) What is the isomorphism type of $\\Theta^3_{\\mathbb{Z}}$? (b) Does there exist a torsion element $[Y]$ in $\\Theta^3_{\\mathbb{Z}}$? (c) Does there exist a torsion element $[Y]\\in\\Theta^3_{\\mathbb{Z}}$ having Rokhlin invariant $\\mu([Y])=1$? (d) Do there exist infinitely-divisible elements in $\\Theta^3_{\\mathbb{Z}}$; that is, does there exist a homology 3-sphere $Y$ such that for infinitely many $n\\in\\mathbb{N}$ there exists $[Z_n]\\in\\Theta^3_{\\mathbb{Z}}$ such that $[Y]=n[Z_n]$?"
          },
          "statement_sha256": "1cdd0ec59659fb383fb04aac3e2d14ada0fd18df4852571d07104d03753a30c7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.69-kirby-problem-3.69-7d105aee-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.69-kirby-problem-3.69-7d105aee-root",
      "route_id": "route:um-kp-3.69-kirby-problem-3.69-7d105aee-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.69-d2f0431dc7e0",
        "url": "https://www.unsolvedmath.com/problems/KP-3.69"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
